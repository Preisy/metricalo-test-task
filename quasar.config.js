...
module.exports = configure(function (/* ctx */) {
  return {
    ...
    boot: ['axios', 'i18n', 'pinia', 'firebase'].map((boot) => '../app/boot/' + boot),
    ...
    build: {
      ...
      alias: {
        // The 'app' alias is reserved
        // Overriding breaks the logic of the sourceFiles section.
